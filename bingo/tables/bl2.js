...
bingoList[2] = [
    ...
    { name:"Complete 'Do No Harm'", types: ["sanctuary", "mystery"] }
];
bingoList[3] = [
    ...
    { name:"Start the Clan War between the Zafords and Hodunks", types: ["dust", "highlands", "war"] },
...
bingoList[4] = [
    ...
    { name:"Kill Doc Mercy", types: ["valley", "mystery"] },
...
bingoList[6] = [
    ...
    { name:"Complete 'You Are Cordially Invited: Party Prep'", types: ["tundra", "tea"] },
    ...
    { name:"Crash the race at the Hodunk Speedway", types: ["dust", "war"] },
    { name:"Build a protective shield for Overlook", types: ["highlands", "karima"] },
    { name:"Collect Tannis' journals around the Highlands", types: ["highlands"] },
    { name:"Complete Doctor's Orders", types: ["wep"] }
];
bingoList[7] = [
    { name:"Invite Fleshstick to Tina's tea party", types: ["tundra", "tea"] },
...
bingoList[9] = [
    ...
    { name:"Complete 'Medical Mystery: X-Com-municate'", types: ["valley", "mystery"] },
    { name:"Escort Matchstick to Flynt's ship", types: ["shelf", "cult"] },
    { name:"Complete the second round of the Bandit Slaughter", types: ["finks", "slaughter"] },
    { name:"Fully test Overlook's new shield", types: ["highlands", "karima"] },
    { name:"Defend Tina's tea party from hostile dinner guests", types: ["tundra", "tea"] },
    { name:"Kill the Bagman in the Zaford cash stash", types: ["highlands", "war"] }
];
bingoList[10] = [
    { name:"Complete 'Rakkaholics Anonymous'", types: ["dust"] },
    { name:"Destroy the Hodunk's trailers", types: ["dust", "war"] },
    { name:"Complete 'Poetic License'", types: ["1kcuts"] },
    { name:"Complete 'Cult Following: The Enkindling'", types: ["frostburn", "cult"] }
];
bingoList[11] = [
